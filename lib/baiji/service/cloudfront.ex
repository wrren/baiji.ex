defmodule Baiji.CloudFront do
  ...
  def create_invalidation(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/distribution/{DistributionId}/invalidation",
      input:            input,
      options:          options,
  ...
  *CloudFront API version*/distribution resource. The request body must
  ...
  def delete_cloud_front_origin_access_identity(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/origin-access-identity/cloudfront/{Id}",
      input:            input,
      options:          options,
  ...
  def delete_distribution(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/distribution/{Id}",
      input:            input,
      options:          options,
  ...
  **To delete an RTMP distribution using the CloudFront API**:
  ...
  def delete_streaming_distribution(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/streaming-distribution/{Id}",
      input:            input,
      options:          options,
  ...
  def get_cloud_front_origin_access_identity_config(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/origin-access-identity/cloudfront/{Id}/config",
      input:            input,
      options:          options,
  ...
  def get_distribution_config(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/distribution/{Id}/config",
      input:            input,
      options:          options,
  ...
  def get_invalidation(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/distribution/{DistributionId}/invalidation/{Id}",
      input:            input,
      options:          options,
  ...
  def get_streaming_distribution_config(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/streaming-distribution/{Id}/config",
      input:            input,
      options:          options,
  ...
  def list_distributions_by_web_a_c_l_id(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/distributionsByWebACLId/{WebACLId}",
      input:            input,
      options:          options,
  ...
  def tag_resource(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/tagging?Operation=Tag",
      input:            input,
      options:          options,
      action:           "TagResource",
      method:           :post,
  ...
  def untag_resource(input \\ %{}, options \\ []) do
    %Baiji.Operation{
      path:             "/2017-03-25/tagging?Operation=Untag",
      input:            input,
      options:          options,
